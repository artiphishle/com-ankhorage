...
printTitle 'starter-expo-stack v1.0.6'
...
git clone --depth 1 --branch 'v1.0.6' git@github.com:artiphishle/starter-expo-stack $pkg &>/dev/null && printSuccess "Package 'starter-expo-stack' downloaded"
